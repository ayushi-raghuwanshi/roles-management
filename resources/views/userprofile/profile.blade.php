    ...
    <div class="col-xl-4">
      <div class="card">
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
          <img src="https://eu.ui-avatars.com/api/?name={{$user->name}}" alt="Profile" class="rounded-circle" height="35%" width="35%">
          <h2>{{$user->name}}</h2>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    ...
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" id="changesMade" value="{{$role->id}}" checked name="roles[]">
